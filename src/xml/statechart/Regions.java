...
public class Regions {
	...
	public Hashtable<Vertices,String> constructSetCRec(int i,Vertices v, Hashtable<String, Vertices> hashId, ArrayList<Vertices> visitados,
														String p, Hashtable<Vertices,String> setCHash, Hashtable<Vertices,Set<String>> hashFilhos) {
